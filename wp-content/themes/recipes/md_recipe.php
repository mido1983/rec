...
?>
    ...
    <section class="single_blog_area section_padding_80">
        <div class="container">
            ...
            <a href="<?php echo get_sub_field('single_post_social_media_link', 'option'); ?>" class="  <?php echo get_sub_field('single_post_social_media_name', 'option'); ?>"><i class="<?php echo get_sub_field('single_post_social_media_icon', 'option'); ?>" aria-hidden="true"></i></a>
                                    <?php   endwhile;
                                else :
                                endif;
                                ?>
                        ...
                        <div class="col-10 col-sm-11">
                            <div class="single-post">
                                ...
                                <div class="post-content">
                                  ...
                                  <p>Tiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                                      ...
                                      aliquaLorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt
                                    ...
                                    <img class="br-30 mb-30" src="<?php echo get_site_url().'/wp-content/themes/recipes/img/blog-img/11.jpg' ?>" alt="">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                                        ...
                                        consequat. Duis aute irure Lorem ipsum dolor sit amet, consectetur adipisicing
                                        elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
                                        ad minim veniam, quis nostrud exercitation ullamco laboris.
                                    </p>

                                    <img class="br-30 mb-30" src="<?php echo get_site_url().'/wp-content/themes/recipes/img/blog-img/12.jpg' ?>" alt="">
                                    ...
                                    <img class="br-30 mb-30" src="<?php echo get_site_url().'/wp-content/themes/recipes/img/blog-img/13.jpg' ?>" alt="">
                                    <h4>You Can Buy For Less Than A College Degree</h4>
                                    ...
                                    <img class="br-30 mb-15" src="<?php echo get_site_url().'/wp-content/themes/recipes/img/blog-img/14.jpg' ?>" alt="">
                                </div>
                            </div>
                            ...
                            <div class="related-post-area section_padding_50">
                                ...
                                <div class="related-post-slider owl-carousel">
                                    ...
                                    <div class="single-post">
                                        <!-- Post Thumb -->
                                        <div class="post-thumb">
                                            <img src="<?php echo get_site_url().'/wp-content/themes/recipes/img/blog-img/15.jpg' ?>" alt="">
                                        </div>
                                        <!-- Post Content -->
                                        <div class="post-content">
                                            <div class="post-meta d-flex">
                                    ...
                                    <div class="single-post">
                                        <!-- Post Thumb -->
                                        <div class="post-thumb">
                                            <img src="<?php echo get_site_url().'/wp-content/themes/recipes/img/blog-img/16.jpg' ?>" alt="">
                                        </div>
                                        <!-- Post Content -->
                                        <div class="post-content">
                                            <div class="post-meta d-flex">
